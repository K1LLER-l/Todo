...
def product_detail (request ,product_id ):
    ...
    tipo_recomendacion ="Similares"

    if mejor_precio_actual >0 :
        alternativas =Producto .objects .filter (
        categoria =producto .categoria ,
        protein_grams__gte =producto .protein_grams ,
        ofertas__price__lt =mejor_precio_actual ,
    ...
    'precio_referencia':mejor_precio_actual ,
    'chart_fechas':fechas ,
...
@login_required 
def set_precio_deseado (request ,product_id ):
    producto =get_object_or_404 (Producto ,pk =product_id )
